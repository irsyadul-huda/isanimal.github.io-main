...
Kami bikin ini karena... kenapa nggak? 😆  
Eksperimen kecil yang mungkin gak penting, tapi bisa jadi keren banget nanti.
...
## 🛠️ Teknologi / Tools
Project ini mungkin (atau mungkin saja tidak 😂) menggunakan:

- HTML, CSS, JavaScript (karena nggak punya framework belum tentu salah)
